...
<div class="wrapper">
   <div class="wrapper-form">
      ...
      <form class="verify" action="register" method="post" enctype="multipart/form-data">
         ...
         <?php } ?>
         <input class="<?= $fieldsError ? 'error-input' : '' ?>" type="text" name="login" value="<?= !empty($_POST['login']) ?? '' ?>" placeholder="Enter Username">
         ...
         <input class="<?= $fieldsError ? 'error-input' : '' ?>" type="number" name="phone" value="<?= empty($_POST['phone']) ? '' : $_POST['phone'] ?>" placeholder="Enter Phone ">
